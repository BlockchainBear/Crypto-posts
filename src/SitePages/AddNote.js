      ...
      <div>
        <form className='addNote' onSubmit={(e) => this.handleSubmit(e)}>
          <fieldset>
            ...
            <br />
            <textarea name='content' placeholder='Enter ammount, and instructions here.' required/>
              
            <br />
            <label htmlFor='targetFolder'>Select a Location</label>
            <br />
